...
- **POST**  device-static information - 
...
- **GET**  device-dynamic information - 
...
- **POST**  device-dynamic information - 
...
### latest-V2.0.12 (date 22/May/2019)

#### Added

 - Already added the `status` info in the `device` 
